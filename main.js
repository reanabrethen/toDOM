...
const printTodo = function(todo) {
  ...
  // newListItem.classList.add('complete')
      ...
      //if to do.complete = true, add class list here
      //only add 'complete' 
...
removeItems = document.querySelector('.remove-todo')

removeItems.addEventListner('click', clearAll)
